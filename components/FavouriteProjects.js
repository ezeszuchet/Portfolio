    ...
    <div className="bg-[#F1F1F1] -mt-40 dark:bg-gray-900">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid md:grid-cols-3 gap-8 lg:-mt-8 pb-40">
          {/* Single card */}
          <a
            href="https://github.com/orgs/The-coffee-world/dashboard"
          ...
          {/* Single card */}
          <a
            href="https://github.com/ezeszuchet/my-journey"
          ...
          {/* Single card */}
          <a
            href="https://github.com/ezeszuchet/open-course-2020-dblandit"
